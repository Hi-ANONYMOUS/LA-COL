...
def get_opts_ee():
    ...
    parser.add_argument('--task', type=str, default="ee")
    parser.add_argument('--input_dir', type=str, default="./data")
    parser.add_argument('--dataset', type=str, default="commodity_news_EE")
    ...
    parser.add_argument('--threshold_head_tail', type=int, default=1200)
    ...
    # report metric
    parser.add_argument('--result_file', type=str, default="com-ee-argument-amr-result.json")
    ...
    parser.add_argument('--resource_file', type=str, default="com-text-dep.txt")
