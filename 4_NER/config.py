...
def get_opts_ner():
    ...
    parser.add_argument('--dataset', type=str, default="genia")
    # parser.add_argument('--dataset', type=str, default="conll03")
    parser.add_argument('--train_file', type=str, default="ner_train.json")
    # parser.add_argument('--test_file', type=str, default="genia_test.json")
    parser.add_argument('--test_file', type=str, default="genia-test-sample500.json")
    # parser.add_argument('--test_file', type=str, default="conll03-test-sample500.json")
    ...
    # report metric
    # parser.add_argument('--result_file', type=str, default="GENIA-1106-LA-CONST-result.json")
    parser.add_argument('--shot_num', type=int, default=3)
    parser.add_argument('--result_file', type=str, default="3-shot-deepseek-V3-ner-nested-amr-result-COL.json")
    ...
    parser.add_argument('--resource_file', type=str, default="genia-test-sample500-amr.txt")
    # 1==1106的LA，2==1106的COL，3==Instruct的LA，4==Instruct的COL
    parser.add_argument('--API_TYPE', type=int, default=2)
