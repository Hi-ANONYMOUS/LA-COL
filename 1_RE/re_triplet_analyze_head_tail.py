...
import json
import sys
from config import get_opts_re
from re_triplet_report_metric import triplet_report_metric_head_tail
cur_path = os.path.abspath("..")
sys.path.append(cur_path)
from utils import Logger


def re_get_head_tail_type(opts):
    ...
    type_file_name = os.path.join(opts.type_file)
