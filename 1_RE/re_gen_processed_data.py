...
def sample_data(dataset, input_file, output_file, k):
    ...
    print("begin sampling: ", in_file_name)
...
if __name__ == "__main__":
    ...
    # # semeval 2010
    # semeval_2010_process("re/sent/semeval2010/", "semeval_train.txt", "train.json")
    # semeval_2010_process("re/semeval2010/", "semeval_test.txt", "test.json")
    # print()

    # # conll04
    # conll04_process("re/sent/conll04/", "train.jsonlines", "train.json")
    # conll04_process("re/conll04/", "test.jsonlines", "test.json")
    # print()
    #
    # # nyt-multi
    # nyt_process("re/sent/nyt-multi", "train.json", "train.json")
    # nyt_process("re/sent/nyt-multi", "test.json", "test.json")
    # print()
    #
    # # tacred
    # tacred_process("re/sent/tacred", "train.json", "train.json")
    # tacred_process("re/sent/tacred", "test.json", "test.json")
    # print()
    #
    # # re-tacred
    # re_tacred_process("re/sent/re-tacred", "train.json", "train.json")
    # re_tacred_process("re/sent/re-tacred", "test.json", "test.json")
    # print()
    #
    # # cpr
    # cpr_process("re/sent/cpr", "train.json", "train.json")
    # cpr_process("re/sent/cpr", "test.json", "test.json")
    # print()
    #
    # # pgr
    # pgr_process("re/sent/pgr", "train.json", "train.json")
    pgr_process("re/pgr", "test.json", "pgr_test.json")
    print()
    #
    # # docred
    # docred_process("re/doc/re-docred", "train_revised.json", "train.json")
    # docred_process("re/doc/re-docred", "test_revised.json", "test.json")
    # print()
    #
    # docred_process("re/doc/dwie", "train_annotated.json", "train.json")
    # docred_process("re/doc/dwie", "test.json", "test.json")
    # print()
    #
    # docred_process("re/doc/docred", "train_annotated.json", "train.json")
    # docred_process("re/doc/docred", "dev.json", "dev.json")
    # print()
    #
    # cdr_gda_process("re/doc/cdr", "train_filter.data", "train.json")
    # cdr_gda_process("re/doc/cdr", "test_filter.data", "test.json")
    # print()
    #
    # cdr_gda_process("re/doc/gda", "train.data", "train.json")
    # cdr_gda_process("re/doc/gda", "test.data", "test.json")
    # print()

    # sample_data("re/sent/nyt-multi", "test.json", "test_3k.json", 3000)
    # sample_data("re/sent/tacred", "test.json", "test_3k.json", 3000)
    # sample_data("re/sent/re-tacred", "test.json", "test_3k.json", 3000)
    # sample_data("re/sent/cpr", "test.json", "test_3k.json", 3000)
