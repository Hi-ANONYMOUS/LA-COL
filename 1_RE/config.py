...
def get_opts_re():
    ...
    # parser.add_argument('--dataset', type=str, default="NYT-multi")
    # parser.add_argument('--dataset', type=str, default="pgr")
    parser.add_argument('--dataset', type=str, default="semeval2010")
    parser.add_argument('--train_file', type=str, default="semeval_train.json")
    # parser.add_argument('--test_file', type=str, default="NYT-multi-sample500-v1.json")
    parser.add_argument('--test_file', type=str, default="semeval-sample500-v1.json")
    # parser.add_argument('--test_file', type=str, default="pgr_test.json")
    ...
    # report metric
    parser.add_argument('--result_file', type=str, default="re_triplet_pos_result_1106.json")
    ...
    parser.add_argument('--resource_file', type=str, default="semeval-sample500-v1-hie.txt")
