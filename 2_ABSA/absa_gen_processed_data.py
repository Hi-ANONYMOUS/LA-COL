...
def absa_data_process(dataset, input_file, output_file):
...
if __name__ == "__main__":
    ## ABSA
    # # wang
    # absa_data_process("absa/wang/14lap", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/wang/14res", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/wang/15res", "train_convert.json", "train_convert.json")
    #
    # absa_data_process("absa/wang/14lap", "test_convert.json", "test_convert.json")  # 800 654 674 0
    # absa_data_process("absa/wang/14res", "test_convert.json", "test_convert.json")  # 800 1134 1008 0
    absa_data_process("absa/wang/15res", "test_convert.json", "test_convert.json")  # 685 542 510 0 -> 681 541 509 0
    # # # aewsome / highly recommended ! / loved it: 0 aspect 0 opinion
    # # # great food: 1 aspect 1 opinion
    # # # fan
    # absa_data_process("absa/fan/14lap", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/fan/14res", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/fan/15res", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/fan/16res", "train_convert.json", "train_convert.json")
    #
    # absa_data_process("absa/fan/14lap", "test_convert.json", "test_convert.json")  # 343 481 498 565 -> ? 重复一个sample -> 481
    # # # the volume is really low to low for a laptopwas not expectin t volume to be so lowan i hate that about this computer
    # absa_data_process("absa/fan/14res", "test_convert.json", "test_convert.json")  # 500 864 888 1030 -> ? 无重复句子，就是864个sample
    # absa_data_process("absa/fan/15res", "test_convert.json", "test_convert.json")  # 325 436 469 493
    # absa_data_process("absa/fan/16res", "test_convert.json", "test_convert.json")  # 329 457 486 525 -> 328 456 485 524 : Great Breakfast
    # # # penga
    # absa_data_process("absa/penga/14lap", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/penga/14res", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/penga/15res", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/penga/16res", "train_convert.json", "train_convert.json")
    #
    # absa_data_process("absa/penga/14lap", "test_convert.json", "test_convert.json")  # 339 418 490 490
    # absa_data_process("absa/penga/14res", "test_convert.json", "test_convert.json")  # 496 726 862 862
    # absa_data_process("absa/penga/15res", "test_convert.json", "test_convert.json")  # 318 403 455 455
    # absa_data_process("absa/penga/16res", "test_convert.json", "test_convert.json")  # 320 405 465 465 -> 319 404 464 464 : Great Breakfast
    # # # pengb
    # absa_data_process("absa/pengb/14lap", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/pengb/14res", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/pengb/15res", "train_convert.json", "train_convert.json")
    # absa_data_process("absa/pengb/16res", "train_convert.json", "train_convert.json")
    #
    # absa_data_process("absa/pengb/14lap", "test_convert.json", "test_convert.json")  # 328 463 474 543
    absa_data_process("absa/pengb/14res", "test_convert.json", "test_convert.json")  # 492 848 854 994
    # absa_data_process("absa/pengb/15res", "test_convert.json", "test_convert.json")  # 322 432 461 485
    # absa_data_process("absa/pengb/16res", "test_convert.json", "test_convert.json")  # 326 452 475 514 -> 325 451 474 513 : Great Breakfast
    #
    #